...
| [Asset Price Forecasting with Dataproc and Prophet](./notebooks/forecast/asset_price_forecast.ipynb) | Financial | Forecast | Asset Price Forecast | PySpark, Dataproc, Apache Iceberg, Prophet, GCS |
