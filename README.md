...
| [Asset Price Forecast using Iceberg and Prophet](./notebooks/classification/asset_price_forecast.ipynb) | Financial | Forecast | Prophet | PySpark, Dataproc, Iceberg, Prophet, GCS, BigQuery |
