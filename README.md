...
| [Asset Price Forecasting with Apache Spark and Prophet](./notebooks/forecast/asset_price_forecast.ipynb) | Financial | Forecast | Asset Price Forecast | PySpark, Prophet, Apache Iceberg, GCS, Pandas |
